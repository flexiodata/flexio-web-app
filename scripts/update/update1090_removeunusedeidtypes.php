...
try
{
    // STEP 1: delete unused eid types; current active eid types are as follows:
    // const TYPE_USER           = 'USR';
    // const TYPE_PIPE           = 'PIP';
    ...
    $db->exec("delete from tbl_object where eid_type not in ('USR','PIP','STR','CTN','CMT','PRC','TKN','RGH');");
}
catch(\Exception $e)
{
