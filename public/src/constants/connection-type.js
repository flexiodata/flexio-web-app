...
export const CONNECTION_TYPE_CAPSULECRM         = 'capsulecrm'
export const CONNECTION_TYPE_CRUNCHBASE         = 'crunchbase'
export const CONNECTION_TYPE_DROPBOX            = 'dropbox'
export const CONNECTION_TYPE_EVENTBRITE         = 'eventbrite'
...
export const CONNECTION_TYPE_HUBSPOT            = 'hubspot'
export const CONNECTION_TYPE_INTERCOM           = 'intercom'
...
export const CONNECTION_TYPE_PIPEDRIVE          = 'pipedrive'
