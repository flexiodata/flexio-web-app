<template>
  <div class="overflow-auto">
    <div class="center tc pv4 ph4 mw7">
      <h1 class="fw6 lh-title mb4" style="font-size: 8rem">404</h1>
      ...
      <p class="mt4">
        <router-link to="/home" class="el-button el-button--large el-button--primary no-underline ttu b">Take me back home</router-link>
      </p>
    </div>
  </div>
</template>
