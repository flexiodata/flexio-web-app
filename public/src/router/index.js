...
const routes = [
  ...
  { path: '/welcome', redirect: '/start' }, // TODO: remove
  ...
  { path: '/:team_name?/integrations/:integration_name/:action?', name: rn.ROUTE_APP_INTEGRATIONS,    component: AppIntegrations,     meta },
  admin_routes,
