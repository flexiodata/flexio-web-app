...
return;
        ...
        \Flexio\Tests\Check::assertString('A.1', 'SetType Job; check basic functionality',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.2', 'SetType Job; check basic functionality',  $actual, $expected, $results);
        ...
        $actual = \Flexio\Tests\Content::getRows($process->getStdout());
        $expected = [[1,1],[2,2],[3,4]];
        \Flexio\Tests\Check::assertString('A.3', 'SetType Job; check basic functionality',  $actual, $expected, $results);
        ...
        $actual = \Flexio\Tests\Content::getRows($process->getStdout());
        $expected = [["1","1"],["2","2"],["3","4"]];
        \Flexio\Tests\Check::assertString('A.4', 'SetType Job; check basic functionality',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.5', 'SetType Job; check basic functionality',  $actual, $expected, $results);
    }
}
