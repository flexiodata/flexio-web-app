...
class Test
{
    public function run(&$results)
    {
        ...
        $expected = true;
        TestCheck::assertBoolean('A.9', '\Flexio\Jobs\Fail definition type constant',  $actual, $expected, $results);
        ...
        $expected = true;
        TestCheck::assertBoolean('A.10', '\Flexio\Jobs\Filter definition type constant',  $actual, $expected, $results);
        ...
        $expected = true;
        TestCheck::assertBoolean('A.23', '\Flexio\Jobs\Search definition type constant',  $actual, $expected, $results);
        ...
        $expected = true;
        TestCheck::assertBoolean('A.24', '\Flexio\Jobs\Select definition type constant',  $actual, $expected, $results);
