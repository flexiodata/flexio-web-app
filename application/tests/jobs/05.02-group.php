...
return;
        ...
        $task = array($create, json_decode('{
            ...
            "params": {
                "group": null,
                "columns": [{"name": "row_count", "function": "count", "expression": "char_1a"}]
            }
        }',true));
        $process = \Flexio\Object\Process::create()->setTask($task)->run(false);
        $actual = TestUtil::getContent($process->getStdout());
        ...
        $task = array($create, json_decode('{
            ...
            "params": {
                "group": null,
                "columns": [{"name": "row_count", "function": "count", "expression": "non-existent-field"}]
            }
        }',true));
        $process = \Flexio\Object\Process::create()->setTask($task)->run(false);
        ...
        $task = array($create, json_decode('{
            ...
            "params": {
                "group": null,
                "columns": [
                    {"name": "count_bool_1d", "function": "count", "expression": "bool_2d"},
                    {"name": "min_bool_1d",   "function": "min",   "expression": "bool_2d"},
                    {"name": "max_bool_1d",   "function": "max",   "expression": "bool_2d"}
                ]
            }
        }',true));
        $process = \Flexio\Object\Process::create()->setTask($task)->run(false);
