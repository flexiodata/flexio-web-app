...
class Test
{
    public function run(&$results)
    {
        ...
        $name = null;
        $value = null;
        $actual = System::getModel()->registry->setBoolean($object_eid, $name, $value);
        $expected = false;
        ...
        $value = '';
        $expires = false;
        $actual = System::getModel()->registry->setBoolean($object_eid, $name, $value, $expires);
        $expected = false;
        ...
        $name = Util::generateHandle();
        $value = '';
        $result = System::getModel()->registry->setBoolean($object_eid, $name, $value);
        $actual = System::getModel()->registry->entryExists($object_eid, $name);
        $expected = true;
        ...
        $object_eid = null;
        $name = null;
        $entry = System::getModel()->registry->getBoolean($object_eid, $name);
        $actual = !isset($entry);
        $expected = true;
        ...
        $object_eid = Eid::generate();
        $name = Util::generateHandle();
        $actual = System::getModel()->registry->getBoolean($object_eid, $name, true);
        $expected = true;
        ...
        $value = true;
        $result = System::getModel()->registry->setBoolean($object_eid, $name, $value);
        $actual = System::getModel()->registry->getBoolean($object_eid, $name, false);
        $expected = true;
        ...
        $value = false;
        $result = System::getModel()->registry->setBoolean($object_eid, $name, $value);
        $actual = System::getModel()->registry->getBoolean($object_eid, 'a', true);
        $expected = true;
        ...
        $value = false;
        $result = System::getModel()->registry->setBoolean($object_eid, $name, $value);
        $actual = System::getModel()->registry->getBoolean('', $name, true);
        $expected = true;
