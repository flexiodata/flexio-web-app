...
class Test
{
    public function run(&$results)
    {
        ...
        // TEST: \Flexio\Model\Connection::delete(); delete tests with non-eid input
        ...
        // TEST: \Flexio\Model\Connection::delete(); delete tests with valid eid input, but object doesn't exist
        ...
        // TEST: \Flexio\Model\Connection::delete(); delete tests with valid eid input, and object exists
