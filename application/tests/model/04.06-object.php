...
class Test
{
    public function run(&$results)
    {
        ...
        $association = System::getModel()->assoc_add($eid1, '', $eid2);
        $actual = $association;
        $expected = false;
        ...
        $eid1 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $association = System::getModel()->assoc_add($eid1, 'x', $eid2);
        $actual = $association;
        $expected = false;
        ...
        $eid1 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $association = System::getModel()->assoc_add('x', Model::EDGE_LINKED_TO, $eid2);
        $actual = $association;
        $expected = false;
        ...
        $eid1 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $association = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, 'x');
        $actual = $association;
        $expected = false;
        ...
        $eid1 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $association1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $association2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $association1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $association2 = System::getModel()->assoc_add($eid2, Model::EDGE_LINKED_TO, $eid1);
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $association1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $association2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_FROM, $eid2);
        $actual = $association1 === true && $association2 === true;
        $expected = true;
