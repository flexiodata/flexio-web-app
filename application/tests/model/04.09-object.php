...
class Test
{
    public function run(&$results)
    {
        ...
        $change_operation = System::getModel()->assoc_change_type($eid1, Model::EDGE_LINKED_TO, $eid2, '');
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_operation = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $change_operation = System::getModel()->assoc_change_type($eid1, '', $eid2, Model::EDGE_LINKED_FROM);
        $actual = $add_operation === true && $change_operation === false;
        $expected = true;
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_operation = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $change_operation = System::getModel()->assoc_change_type($eid1, Model::EDGE_LINKED_FROM, $eid2, Model::EDGE_LINKED_TO);
        $actual = $add_operation === true && $change_operation === false;
        $expected = true;
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_operation = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $change_operation = System::getModel()->assoc_change_type($eid1, Model::EDGE_LINKED_TO, $eid2, Model::EDGE_LINKED_TO);
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_operation = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $change_operation = System::getModel()->assoc_change_type('x', Model::EDGE_LINKED_TO, $eid2, Model::EDGE_LINKED_FROM);
        $actual = $add_operation === true && $change_operation === false;
        $expected = true;
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_operation = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $change_operation = System::getModel()->assoc_change_type($eid1, Model::EDGE_LINKED_TO, 'x', Model::EDGE_LINKED_FROM);
        $actual = $add_operation === true && $change_operation === false;
        $expected = true;
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_operation = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $change_operation = System::getModel()->assoc_change_type($eid1, Model::EDGE_LINKED_TO, $eid2, Model::EDGE_LINKED_FROM);
        $actual = $add_operation === true && $change_operation === true;
        $expected = true;
        ...
        $change_operation = System::getModel()->assoc_change_type($eid1, Model::EDGE_LINKED_TO, $eid2, Model::EDGE_LINKED_FROM);
        $count_original_after_change = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_TO);
        $count_new_after_change = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_FROM);
        ...
        $eid1 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_operation1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_operation2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_FROM, $eid2);
        $change_operation = System::getModel()->assoc_change_type($eid1, Model::EDGE_LINKED_TO, $eid2, Model::EDGE_LINKED_FROM);
        ...
        $add_operation = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $count_after_addition = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_TO);
        $change_operation = System::getModel()->assoc_change_type($eid3, Model::EDGE_LINKED_TO, $eid2, Model::EDGE_LINKED_FROM);
        $count_original_after_change = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_TO);
        $count_new_after_change = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_FROM);
        ...
        $add_operation = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $count_after_addition = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_TO);
        $change_operation = System::getModel()->assoc_change_type($eid1, Model::EDGE_LINKED_TO, $eid3, Model::EDGE_LINKED_FROM);
        $count_original_after_change = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_TO);
        $count_new_after_change = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_FROM);
        $actual = $count_after_addition === 1 && $count_original_after_change === 1 && $count_new_after_change === 0;
        $expected = true;
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_operation1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_operation2 = System::getModel()->assoc_add($eid1, Model::EDGE_HAS_MEMBER, $eid2);
        $count_association1 = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_TO);
        $count_association2 = System::getModel()->assoc_count($eid1, Model::EDGE_HAS_MEMBER);
        $change_operation = System::getModel()->assoc_change_type($eid1, Model::EDGE_LINKED_TO, $eid2, Model::EDGE_LINKED_FROM);
        $count_original_after_change = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_TO);
        $count_new_after_change = System::getModel()->assoc_count($eid1, Model::EDGE_LINKED_FROM);
