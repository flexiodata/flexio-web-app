...
class Test
{
    public function run(&$results)
    {
        ...
        $name = null;
        $value = null;
        $actual = System::getModel()->registry->setString($object_eid, $name, $value);
        $expected = false;
        ...
        $value = '';
        $expires = 'a';
        $actual = System::getModel()->registry->setString($object_eid, $name, $value, $expires);
        $expected = false;
        ...
        $name = Util::generateHandle();
        $value = '';
        $result = System::getModel()->registry->setString($object_eid, $name, $value);
        $actual = System::getModel()->registry->entryExists($object_eid, $name);
        $expected = true;
        ...
        $object_eid = null;
        $name = null;
        $entry = System::getModel()->registry->getString($object_eid, $name);
        $actual = !isset($entry);
        $expected = true;
        ...
        $object_eid = Eid::generate();
        $name = Util::generateHandle();
        $actual = System::getModel()->registry->getString($object_eid, $name, 'value');
        $expected = 'value';
        ...
        $result = System::getModel()->registry->setString($object_eid, $name, $value);
        $actual = System::getModel()->registry->getString($object_eid, $name, 'default');
        $expected = $value;
        ...
        $value = Util::generateHandle();
        $result = System::getModel()->registry->setString($object_eid, $name, $value);
        $actual = System::getModel()->registry->getString($object_eid, 'a', 'default');
        $expected = 'default';
        ...
        $value = Util::generateHandle();
        $result = System::getModel()->registry->setString($object_eid, $name, $value);
        $actual = System::getModel()->registry->getString('', $name, 'default');
        $expected = 'default';
