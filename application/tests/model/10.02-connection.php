...
class Test
{
    public function run(&$results)
    {
        ...
        // TEST: \Flexio\Model\Connection::create(); connection creation with no parameters
        ...
        // TEST: \Flexio\Model\Connection::create(); connection creation with basic name input
