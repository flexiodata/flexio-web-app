...
class Test
{
    public function run(&$results)
    {
        ...
        $range_result = System::getModel()->assoc_range($eid1, 'x');
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $range_result = System::getModel()->assoc_range($eid1, Model::EDGE_UNDEFINED);
        $has_errors = System::getModel()->hasErrors();
        $actual = $has_errors;
        $expected = true;
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $range_result = System::getModel()->assoc_range('x', Model::EDGE_LINKED_TO);
        ...
        $eid3 = Eid::generate();
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $range_result = System::getModel()->assoc_range($eid3, Model::EDGE_LINKED_TO);
        $actual = $add_result === true && $range_result === array();
        $expected = true;
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $range_result = System::getModel()->assoc_range($eid1, Model::EDGE_LINKED_TO);
        $actual = $range_result;
        $expected = array(
            array('eid' => $eid2)
        );
        ...
        $eid3 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_FROM, $eid3);
        $range_result = System::getModel()->assoc_range($eid1, Model::EDGE_LINKED_FROM);
        $actual = $range_result;
        $expected = array(
            array('eid' => $eid3)
        );
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid2, Model::EDGE_LINKED_TO, $eid1);
        $range_result = System::getModel()->assoc_range($eid1, Model::EDGE_LINKED_TO);
        $actual = $range_result;
        $expected = array(
            array('eid' => $eid2)
        ...
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid3);
        $delete_result = System::getModel()->delete($eid3);
        $range_result = System::getModel()->assoc_range($eid1, Model::EDGE_LINKED_TO);
        $actual = $range_result;
        $expected = array(
        ...
        $eid3 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid3);
        $range_result = System::getModel()->assoc_range($eid1, Model::EDGE_LINKED_TO);
        $actual = $range_result;
        $expected = array(
            array('eid' => $eid2),
