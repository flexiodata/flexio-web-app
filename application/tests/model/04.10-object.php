...
class Test
{
    public function run(&$results)
    {
        ...
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $get_result = System::getModel()->assoc_get($eid1, 'x', $eid2);
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_UNDEFINED, $eid2);
        $actual = $add_result === true && $get_result === false;
        $expected = true;
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $get_result = System::getModel()->assoc_get('x', Model::EDGE_LINKED_TO, $eid2);
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, 'x');
        $actual = $add_result === true && $get_result === array();
        $expected = true;
        ...
        $eid3 = Eid::generate();
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $get_result = System::getModel()->assoc_get($eid3, Model::EDGE_LINKED_TO, $eid2);
        $actual = $add_result === true && $get_result === array();
        $expected = true;
        ...
        $eid3 = Eid::generate();
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, $eid3);
        $actual = $add_result === true && $get_result === array();
        $expected = true;
        ...
        $eid3 = Eid::generate();
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, "$eid3,$eid3");
        $actual = $add_result === true && $get_result === array();
        $expected = true;
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, $eid2);
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2)
        );
        ...
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid3);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, $eid2);
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2)
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $delete_result = System::getModel()->assoc_delete($eid1, Model::EDGE_LINKED_TO, $eid2);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, $eid2);
        $actual = $get_result;
        $expected = array(
        );
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $delete_result = System::getModel()->delete($eid1);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, $eid2);
        $actual = $get_result;
        $expected = array(
        );
        ...
        $eid2 = System::getModel()->create(Model::TYPE_OBJECT, $info);
        $add_result = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $delete_result = System::getModel()->delete($eid2);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, $eid2);
        $actual = $get_result;
        $expected = array(
        );
        ...
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid3);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, "$eid2,$eid3");
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2),
            array('eid' => $eid3)
        ...
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid3);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, "$eid3,$eid2");
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2),
            array('eid' => $eid3)
        ...
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid3);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, "$eid2,$eid3,$eid4");
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2),
            array('eid' => $eid3)
        ...
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid3);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, "$eid4,$eid2,x,null,,,,$eid3");
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2),
            array('eid' => $eid3)
        ...
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid3);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, "$eid2,$eid2,$eid2");
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2)
        );
        ...
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid3);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, array($eid2));
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2)
        );
        ...
        $add_result1 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = System::getModel()->assoc_add($eid1, Model::EDGE_LINKED_TO, $eid3);
        $get_result = System::getModel()->assoc_get($eid1, Model::EDGE_LINKED_TO, array($eid2,$eid3));
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2),
            array('eid' => $eid3)
