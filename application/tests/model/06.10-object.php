...
class Test
{
    public function run(&$results)
    {
        ...
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, 'x', [$eid2]);
        ...
        $eid2 = \Flexio\Tests\Util::getModel()->create(\Model::TYPE_OBJECT, $info);
        $add_result = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_UNDEFINED, [$eid2]);
        $actual = $add_result === true && $get_result === array();
        $expected = true;
        ...
        $eid2 = \Flexio\Tests\Util::getModel()->create(\Model::TYPE_OBJECT, $info);
        $add_result = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get('x', \Model::EDGE_LINKED_TO, [$eid2]);
        $actual = $add_result === true && $get_result === array();
        $expected = true;
        ...
        $eid2 = \Flexio\Tests\Util::getModel()->create(\Model::TYPE_OBJECT, $info);
        $add_result = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, ['x']);
        $actual = $add_result === true && $get_result === array();
        $expected = true;
        ...
        $add_result = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid3, \Model::EDGE_LINKED_TO, [$eid2]);
        $actual = $add_result === true && $get_result === array();
        $expected = true;
        ...
        $eid3 = \Flexio\Base\Eid::generate();
        $add_result = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, [$eid3]);
        $actual = $add_result === true && $get_result === array();
        $expected = true;
        ...
        $eid3 = \Flexio\Base\Eid::generate();
        $add_result = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, [$eid3,$eid3]);
        $actual = $add_result === true && $get_result === array();
        $expected = true;
        ...
        $eid2 = \Flexio\Tests\Util::getModel()->create(\Model::TYPE_OBJECT, $info);
        $add_result = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, [$eid2]);
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2)
        );
        ...
        $eid2 = \Flexio\Tests\Util::getModel()->create(\Model::TYPE_OBJECT, $info);
        $add_result = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $delete_result = \Flexio\Tests\Util::getModel()->delete($eid2);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, [$eid2]);
        $actual = $get_result;
        $expected = array(
        );
        ...
        $add_result1 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid3);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, [$eid2,$eid3]);
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2),
            array('eid' => $eid3)
        ...
        $add_result1 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid3);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, [$eid3,$eid2]);
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2),
            array('eid' => $eid3)
        ...
        $add_result1 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid3);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, [$eid2,$eid3,$eid4]);
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2),
            array('eid' => $eid3)
        ...
        $add_result1 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid3);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, [$eid4,$eid2,'x',null,$eid3]);
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2),
            array('eid' => $eid3)
        ...
        $add_result1 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid3);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, [null,null,null,$eid2,null,null,null]);
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2)
        );
        ...
        $add_result1 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid2);
        $add_result2 = \Flexio\Tests\Util::getModel()->assoc_add($eid1, \Model::EDGE_LINKED_TO, $eid3);
        $get_result = \Flexio\Tests\Util::getModel()->assoc_get($eid1, \Model::EDGE_LINKED_TO, [$eid2,$eid2,$eid2]);
        $actual = $get_result;
        $expected = array(
            array('eid' => $eid2)
        );
