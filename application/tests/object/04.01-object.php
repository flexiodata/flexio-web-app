...
class Test
{
    public function run(&$results)
    {
        ...
        $expected = true;
        TestCheck::assertBoolean('C.4', 'Object::delete(); make sure the status is set to deleted',  $actual, $expected, $results);
        ...
        $expected = true;
        TestCheck::assertBoolean('F.5', 'Object::setStatus(); make sure the status is set',  $actual, $expected, $results);
    }
}
