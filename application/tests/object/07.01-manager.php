...
class Test
{
    public function run(&$results)
    {
        ...
        TestCheck::assertArray('A.1', 'Manager::handleEmail(); test to see if an email is inserted into a process when it runs', $actual, $expected, $results, TestCheck::FLAG_ERROR_SUPPRESS);
    }
}
