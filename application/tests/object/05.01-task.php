...
class Test
{
    public function run(&$results)
    {
        ...
        // BEGIN TEST
        $task = \Flexio\Object\Task::create([
                ["type" => "flexio.create", "params" => (object)[]],
                ["type" => "flexio.convert", "params" => (object)[]]
            ]);
        $actual = $task->get()[0]['type'] === "flexio.create" && $task->get()[1]['type'] === "flexio.convert";
        $expected = true;
        ...
        // BEGIN TEST
        $task = \Flexio\Object\Task::create()->push(["type" => "flexio.create", "params" => (object)[]]);
        $actual = $task->get()[0]['type'];
        $expected = "flexio.create";
        TestCheck::assertString('B.5', 'Task::push(); add valid steps', $actual, $expected, $results);

        // BEGIN TEST
        $task = \Flexio\Object\Task::create()
                                ->push(["type" => "flexio.create", "params" => (object)[]])
                                ->push(["type" => "flexio.convert", "params" => (object)[]]);
        $actual = $task->get()[0]['type'] === "flexio.create" && $task->get()[1]['type'] === "flexio.convert";
        $expected = true;
        ...
        // BEGIN TEST
        $task = \Flexio\Object\Task::create()
                        ->push(["type" => "flexio.create"])
                        ->push(["type" => "flexio.convert"])
                        ->push(["type" => "flexio.filter"]);
        $task_list = $task->pop()->get();
        $actual = end($task_list)['type'];
        $expected = "flexio.convert";
        ...
        // BEGIN TEST
        $task = \Flexio\Object\Task::create();
        $task->addTaskStep(["type" => "flexio.create", "params" => (object)[]]);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.create", "params" => (object)[]]
        ];
        ...
        $task = \Flexio\Object\Task::create();
        $task->addTaskStep(["eid" => $eid1, "type" => "flexio.create", "params" => (object)[]]);
        $result = $task->get();
        ...
        $task = \Flexio\Object\Task::create();
        $task->addTaskStep(["type" => "flexio.create", "params" => (object)[]]);
        $task->addTaskStep(["type" => "flexio.convert", "params" => (object)[]]);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.create", "params" => (object)[]],
                ["type" => "flexio.convert", "params" => (object)[]]
        ...
        $task->addTaskStep(["type" => "flexio.nop", "params" => (object)[]]);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.convert", "params" => (object)[]],
                ["type" => "flexio.create", "params" => (object)[]],
                ["type" => "flexio.nop", "params" => (object)[]]
        ];
        ...
        $task = \Flexio\Object\Task::create($steps);
        $task->addTaskStep(["type" => "flexio.nop", "params" => (object)[]], null);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.convert", "params" => (object)[]],
                ["type" => "flexio.create", "params" => (object)[]],
        ...
        try
        {
            ...
            $task = \Flexio\Object\Task::create($steps);
            $task->addTaskStep(["type" => "flexio.nop", "params" => (object)[]], 'a');
            $actual = \Flexio\Tests\TestError::ERROR_NO_EXCEPTION;
        }
        catch (\Error $e)
        {
        ...
        // BEGIN TEST
        $task = \Flexio\Object\Task::create();
        $task->addTaskStep(["type" => "flexio.nop", "params" => (object)[]], -1);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.nop", "params" => (object)[]]
        ];
        ...
        // BEGIN TEST
        $task = \Flexio\Object\Task::create();
        $task->addTaskStep(["type" => "flexio.nop", "params" => (object)[]], 0);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.nop", "params" => (object)[]]
        ];
        ...
        // BEGIN TEST
        $task = \Flexio\Object\Task::create();
        $task->addTaskStep(["type" => "flexio.create", "params" => (object)[]], 0);
        $task->addTaskStep(["type" => "flexio.convert", "params" => (object)[]], 0);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.convert", "params" => (object)[]],
                ["type" => "flexio.create", "params" => (object)[]]
        ...
        $task = \Flexio\Object\Task::create();
        $task->addTaskStep(["type" => "flexio.create", "params" => (object)[]], 0);
        $task->addTaskStep(["type" => "flexio.convert", "params" => (object)[]], 1);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.create", "params" => (object)[]],
                ["type" => "flexio.convert", "params" => (object)[]]
        ...
        $task = \Flexio\Object\Task::create($steps);
        $task->addTaskStep(["type" => "flexio.nop", "params" => (object)[]], 2);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.convert", "params" => (object)[]],
                ["type" => "flexio.create", "params" => (object)[]],
        ...
        $task = \Flexio\Object\Task::create($steps);
        $task->addTaskStep(["type" => "flexio.nop", "params" => (object)[]], 3);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.convert", "params" => (object)[]],
                ["type" => "flexio.create", "params" => (object)[]],
        ...
        try
        {
            ...
            $task = \Flexio\Object\Task::create($steps);
            $task->setTaskStep(null, ["type" => "flexio.nop", "params" => (object)[]]);
            $actual = \Flexio\Tests\TestError::ERROR_NO_EXCEPTION;
        }
        catch (\Error $e)
        {
        ...
        try
        {
            ...
            $task = \Flexio\Object\Task::create($steps);
            $task->setTaskStep(1, ["type" => "flexio.nop", "params" => (object)[]]);
            $actual = \Flexio\Tests\TestError::ERROR_NO_EXCEPTION;
        }
        catch (\Error $e)
        {
        ...
        $task = \Flexio\Object\Task::create($steps);
        $task_list = $task->get();
        $task->setTaskStep($task_list[0]['eid'], ["type" => "flexio.nop", "params" => (object)[]]);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.nop", "params" => (object)[]],
                ["type" => "flexio.convert", "params" => (object)[]]
        ...
        $task = \Flexio\Object\Task::create($steps);
        $task_list = $task->get();
        $task->setTaskStep($task_list[1]['eid'], ["type" => "flexio.nop", "params" => (object)[]]);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.create", "params" => (object)[]],
                ["type" => "flexio.nop", "params" => (object)[]]
        ...
        $task = \Flexio\Object\Task::create($steps);
        $task->setTaskStep(\Flexio\Base\Eid::generate(), ["type" => "flexio.nop", "params" => (object)[]]);
        $actual = $task->get();
        $expected = [
                ["type" => "flexio.create", "params" => (object)[]],
                ["type" => "flexio.convert", "params" => (object)[]]
        ...
        $task = \Flexio\Object\Task::create($steps);
        $task_list = $task->get();
        $task->setTaskStep($task_list[1]['eid'], ["eid" => $eid1, "type" => "flexio.nop", "params" => (object)[]]);
        $actual = $task->get();
        $expected = [
                ["eid" => $task_list[1]['eid'], "type" => "flexio.nop", "params" => (object)[]]
        ];
        ...
        $expected = ["type" => "flexio.create", "params" => (object)[]];
        ...
        $expected = ["type" => "flexio.convert", "params" => (object)[]];
