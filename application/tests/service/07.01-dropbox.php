...
class Test
{
    ...
    {
        if (\Flexio\Tests\Base::TEST_STORAGE_DROPBOX === false)
            return;
        ...
        catch (\Flexio\Base\Exception $e)
        {
            ...
            \Flexio\Tests\Check::assertString("B.1", '\Flexio\Services\Dropbox::getFileInfo(); check exception code' . $storage_location,  $actual, $expected, $results);
        }
        ...
        catch (\Flexio\Base\Exception $e)
        {
            ...
            $actual = $error['code'];
            $expected = \Flexio\Base\Error::UNAVAILABLE;
            \Flexio\Tests\Check::assertString("B.2", '\Flexio\Services\Dropbox::getFileInfo(); check exception code' . $storage_location,  $actual, $expected, $results);
        }
        ...
        try
        {
            ...
            \Flexio\Tests\Check::assertInArray("B.3", '\Flexio\Services\Dropbox::getFileInfo(); basic file info check on: ' . $storage_location,  $actual, $expected, $results);
        }
        catch (\Flexio\Base\Exception $e)
        {
            $actual = \Flexio\Tests\Base::ERROR_EXCEPTION;
            $expected = \Flexio\Tests\Base::ERROR_NO_EXCEPTION;
            \Flexio\Tests\Check::assertString("B.3", '\Flexio\Services\Dropbox::getFileInfo(); basic file info check on: ' . $storage_location,  $actual, $expected, $results);
        }
        ...
        try
        {
            ...
            \Flexio\Tests\Check::assertInArray("B.4", '\Flexio\Services\Dropbox::getFileInfo(); basic file info check on: ' . $storage_location,  $actual, $expected, $results);
        }
        catch (\Flexio\Base\Exception $e)
        {
            $actual = \Flexio\Tests\Base::ERROR_EXCEPTION;
            $expected = \Flexio\Tests\Base::ERROR_NO_EXCEPTION;
            \Flexio\Tests\Check::assertString("B.4", '\Flexio\Services\Dropbox::getFileInfo(); basic file info check on: ' . $storage_location,  $actual, $expected, $results);
        }
    }
}
