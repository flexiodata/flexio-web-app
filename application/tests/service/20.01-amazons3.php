...
class Test
{
    ...
    {
        if (\Flexio\Tests\Base::TEST_SERVICE_AMAZONS3 === false)
            return;


        // SETUP
        $test_user_eid = \Flexio\Tests\Util::getTestStorageOwner();
        $test_connection_eid = \Flexio\Object\Connection::getEidFromName($test_user_eid, \Flexio\Tests\Base::STORAGE_AMAZONS3);
        ...
        // BEGIN TEST
        $instance = new \Flexio\Services\AmazonS3;
        ...
        catch (\Flexio\Base\Exception $e)
        {
            ...
            \Flexio\Tests\Check::assertString("B.1", '\Flexio\Services\AmazonS3::getFileInfo(); check exception code',  $actual, $expected, $results);
        }
        ...
        catch (\Flexio\Base\Exception $e)
        {
            ...
            $actual = $error['code'];
            $expected = \Flexio\Base\Error::UNAVAILABLE;
            \Flexio\Tests\Check::assertString("B.2", '\Flexio\Services\AmazonS3::getFileInfo(); check exception code',  $actual, $expected, $results);
        }
        ...
        try
        {
            ...
            \Flexio\Tests\Check::assertInArray("B.3", '\Flexio\Services\AmazonS3::getFileInfo(); basic file info check',  $actual, $expected, $results);
        }
        catch (\Flexio\Base\Exception $e)
        {
            $actual = \Flexio\Tests\Base::ERROR_EXCEPTION;
            $expected = \Flexio\Tests\Base::ERROR_NO_EXCEPTION;
            \Flexio\Tests\Check::assertString("B.3", '\Flexio\Services\AmazonS3::getFileInfo(); basic file info check',  $actual, $expected, $results);
        }
        ...
        try
        {
            ...
            \Flexio\Tests\Check::assertInArray("B.4", '\Flexio\Services\AmazonS3::getFileInfo(); basic file info check',  $actual, $expected, $results);
        }
        catch (\Flexio\Base\Exception $e)
        {
            $actual = \Flexio\Tests\Base::ERROR_EXCEPTION;
            $expected = \Flexio\Tests\Base::ERROR_NO_EXCEPTION;
            \Flexio\Tests\Check::assertString("B.4", '\Flexio\Services\AmazonS3::getFileInfo(); basic file info check',  $actual, $expected, $results);
        }
    }
}
