...
class Test
{
    public function run(&$results)
    {
        ...
        catch (\Flexio\Base\Exception $e)
        {
            ...
            \Flexio\Tests\Check::assertString("B.1", '\Flexio\Services\GoogleSheets::getFileInfo(); check exception code' . $storage_location,  $actual, $expected, $results);
        }
        ...
        catch (\Flexio\Base\Exception $e)
        {
            ...
            $actual = $error['code'];
            $expected = \Flexio\Base\Error::UNAVAILABLE;
            \Flexio\Tests\Check::assertString("B.2", '\Flexio\Services\GoogleSheets::getFileInfo(); check exception code' . $storage_location,  $actual, $expected, $results);
        }
        ...
        try
        {
            ...
            \Flexio\Tests\Check::assertInArray("B.3", '\Flexio\Services\GoogleSheets::getFileInfo(); basic file info check on: ' . $storage_location,  $actual, $expected, $results);
        }
        catch (\Flexio\Base\Exception $e)
        {
            $actual = \Flexio\Tests\Base::ERROR_EXCEPTION;
            $expected = \Flexio\Tests\Base::ERROR_NO_EXCEPTION;
            \Flexio\Tests\Check::assertString("B.3", '\Flexio\Services\GoogleSheets::getFileInfo(); basic file info check on: ' . $storage_location,  $actual, $expected, $results);
        }
        ...
        try
        {
            ...
            \Flexio\Tests\Check::assertInArray("B.4", '\Flexio\Services\GoogleSheets::getFileInfo(); basic file info check on: ' . $storage_location,  $actual, $expected, $results);
        }
        catch (\Flexio\Base\Exception $e)
        {
            $actual = \Flexio\Tests\Base::ERROR_EXCEPTION;
            $expected = \Flexio\Tests\Base::ERROR_NO_EXCEPTION;
            \Flexio\Tests\Check::assertString("B.4", '\Flexio\Services\GoogleSheets::getFileInfo(); basic file info check on: ' . $storage_location,  $actual, $expected, $results);
        }
    }
}
