...
class Test
{
    public function run(&$results)
    {
        ...
        TestCheck::assertArray('B.21', '\Flexio\Services\Email::parseText(); get the "from" addresses', $actual, $expected, $results);
        ...
        $actual = $email->getFrom();
        $expected = '["sende\u00e4r <sender@test.com>"]';
        TestCheck::assertArray('B.22', '\Flexio\Services\Email::parseText(); get the "from" addresses', $actual, $expected, $results);
        ...
        TestCheck::assertArray('B.23', '\Flexio\Services\Email::parseText(); get the "from" addresses', $actual, $expected, $results);
        ...
        TestCheck::assertArray('B.24', '\Flexio\Services\Email::parseText(); get the "from" addresses', $actual, $expected, $results);
        ...
        $actual = $email->getFrom();
        $expected = '["Name <name@company.com>"]';
        TestCheck::assertArray('B.25', '\Flexio\Services\Email::parseText(); get the "from" addresses', $actual, $expected, $results);
        ...
        TestCheck::assertArray('B.26', '\Flexio\Services\Email::parseText(); get the "from" addresses', $actual, $expected, $results);
        ...
        TestCheck::assertArray('C.21', '\Flexio\Services\Email::parseText(); get the "to" addresses', $actual, $expected, $results);
        ...
        $actual = $email->getTo();
        $expected = '["test <test@asdasd.com>"]';
        TestCheck::assertArray('C.22', '\Flexio\Services\Email::parseText(); get the "to" addresses', $actual, $expected, $results);
        ...
        TestCheck::assertArray('C.23', '\Flexio\Services\Email::parseText(); get the "to" addresses', $actual, $expected, $results);
        ...
        TestCheck::assertArray('C.24', '\Flexio\Services\Email::parseText(); get the "to" addresses', $actual, $expected, $results);
        ...
        $actual = $email->getTo();
        $expected = '["Name <name@company2.com>"]';
        TestCheck::assertArray('C.25', '\Flexio\Services\Email::parseText(); get the "to" addresses', $actual, $expected, $results);
        ...
        TestCheck::assertArray('C.26', '\Flexio\Services\Email::parseText(); get the "to" addresses', $actual, $expected, $results);
        ...
        TestCheck::assertString('D.21', '\Flexio\Services\Email::parseText(); get the "subject"', $actual, $expected, $results);
        ...
        TestCheck::assertString('D.22', '\Flexio\Services\Email::parseText(); get the "subject"', $actual, $expected, $results);
        ...
        TestCheck::assertString('D.23', '\Flexio\Services\Email::parseText(); get the "subject"', $actual, $expected, $results);
        ...
        TestCheck::assertString('D.24', '\Flexio\Services\Email::parseText(); get the "subject"', $actual, $expected, $results);
        ...
        $actual = $email->getSubject();
        $expected = 'Testing MIME E-mail composing with cid';
        TestCheck::assertString('D.25', '\Flexio\Services\Email::parseText(); get the "subject"', $actual, $expected, $results);
        ...
        TestCheck::assertString('D.26', '\Flexio\Services\Email::parseText(); get the "subject"', $actual, $expected, $results);
        ...
        TestCheck::assertString('E.21', '\Flexio\Services\Email::parseText(); get the message text', $actual, $expected, $results);
        ...
        $actual = substr($email->getMessageText(),200,50);
        $expected = "directly above this quoted-printable wrapper, than";
        TestCheck::assertString('E.22', '\Flexio\Services\Email::parseText(); get the message text', $actual, $expected, $results);
        ...
        $actual = substr($email->getMessageText(),200,50);
        $expected = "directly above this quoted-printable wrapper, than";
        TestCheck::assertString('E.23', '\Flexio\Services\Email::parseText(); get the message text', $actual, $expected, $results);
        ...
        $actual = $email->getMessageText();
        $expected = "";
        TestCheck::assertString('E.24', '\Flexio\Services\Email::parseText(); get the message text', $actual, $expected, $results);
        ...
        $actual = $email->getMessageText();
        $expected = "This is an HTML message. Please use an HTML capable mail program to read\nthis message.\n";
        TestCheck::assertString('E.25', '\Flexio\Services\Email::parseText(); get the message text', $actual, $expected, $results);
        ...
        TestCheck::assertString('E.26', '\Flexio\Services\Email::parseText(); get the message text', $actual, $expected, $results);
        ...
        $expected = "";
        TestCheck::assertString('F.9', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.11', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.12', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.13', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.14', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.16', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        //$actual = $email->getMessageHtml();
        //$expected = "";
        //TestCheck::assertString('F.17', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.18', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.19', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.21', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.22', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.23', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.24', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = substr_count($email->getMessageHtml(),"<");
        $expected = 37;
        TestCheck::assertNumber('F.25', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
        ...
        $actual = $email->getMessageHtml();
        $expected = "";
        TestCheck::assertString('F.26', '\Flexio\Services\Email::parseText(); get the message html', $actual, $expected, $results);
    }
}
