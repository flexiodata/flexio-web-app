...
class Test
{
    public function run(&$results)
    {
        ...
        $actual = \Flexio\Api\Response::getHttpErrorCode($flexio_error_code);
        $expected = 500;
        \Flexio\Tests\Check::assertNumber('A.25', '\Flexio\Api\Response::getHttpErrorCode(); check http error code mapping',  $actual, $expected, $results);

        // BEGIN TEST
        $flexio_error_code = \Flexio\Base\Error::NO_DATABASE;
        $actual = \Flexio\Api\Response::getHttpErrorCode($flexio_error_code);
        $expected = 500;
        \Flexio\Tests\Check::assertNumber('A.26', '\Flexio\Api\Response::getHttpErrorCode(); check http error code mapping',  $actual, $expected, $results);

        // BEGIN TEST
        $flexio_error_code = \Flexio\Base\Error::NO_MODEL;
        $actual = \Flexio\Api\Response::getHttpErrorCode($flexio_error_code);
        $expected = 500;
        \Flexio\Tests\Check::assertNumber('A.27', '\Flexio\Api\Response::getHttpErrorCode(); check http error code mapping',  $actual, $expected, $results);

        // BEGIN TEST
        $flexio_error_code = \Flexio\Base\Error::NO_SERVICE;
        $actual = \Flexio\Api\Response::getHttpErrorCode($flexio_error_code);
        $expected = 500;
        \Flexio\Tests\Check::assertNumber('A.28', '\Flexio\Api\Response::getHttpErrorCode(); check http error code mapping',  $actual, $expected, $results);
    }
}
