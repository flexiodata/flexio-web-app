...
class Test
{
    public function run(&$results)
    {
        ...
        $actual = \Flexio\Api\Action::TYPE_GENERAL;
        $expected = 'action.general';
        ...
        \Flexio\Tests\Check::assertString('A.42', 'Action type',  $actual, $expected, $results);

        $actual = \Flexio\Api\Action::TYPE_STREAM_READ;
        $expected = 'action.stream.read';
        \Flexio\Tests\Check::assertString('A.43', 'Action type',  $actual, $expected, $results);

        $actual = \Flexio\Api\Action::TYPE_SYSTEM_READ;
        $expected = 'action.system.read';
        \Flexio\Tests\Check::assertString('A.44', 'Action type',  $actual, $expected, $results);

        // user interface actions
        $actual = \Flexio\Api\Action::TYPE_UI_SEARCH ;
        $expected = 'action.ui.search';
        \Flexio\Tests\Check::assertString('A.45', 'Action type',  $actual, $expected, $results);

        $actual = \Flexio\Api\Action::TYPE_UI_BUTTONCLICK;
        $expected = 'action.ui.buttonclick';
        \Flexio\Tests\Check::assertString('A.46', 'Action type',  $actual, $expected, $results);
    }
}
