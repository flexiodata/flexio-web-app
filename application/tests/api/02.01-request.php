...
class Test
{
    public function run(&$results)
    {
        ...
        $request = \Flexio\Api2\Request::create();
        $request->setIpAddress($request_ip_address);
        $actual = $request->getIpAddress();
        $expected = $request_ip_address;
        \Flexio\Tests\Check::assertString('A.1', '\Flexio\Api2\Request::setIpAddress(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.2', '\Flexio\Api2\Request::setToken(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.3', '\Flexio\Api2\Request::setMethod(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.4', '\Flexio\Api2\Request::setUrl(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.5', '\Flexio\Api2\Request::setRequestingUser(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.6', '\Flexio\Api2\Request::setRequestCreated(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.7', '\Flexio\Api2\Request::setOwnerFromUrl(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.8', '\Flexio\Api2\Request::setObjectFromUrl(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.9', '\Flexio\Api2\Request::setObjectEidType(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.10', '\Flexio\Api2\Request::setResponseCode(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertString('A.11', '\Flexio\Api2\Request::setResponseCreated(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertArray('A.12', '\Flexio\Api2\Request::setResponseParams(); basic set',  $actual, $expected, $results);
        ...
        $expected = $url_params;
        \Flexio\Tests\Check::assertArray('A.13', '\Flexio\Api2\Request::setUrlParams(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertArray('A.14', '\Flexio\Api2\Request::setQueryParams(); basic set',  $actual, $expected, $results);
        ...
        \Flexio\Tests\Check::assertArray('A.15', '\Flexio\Api2\Request::setPostParams(); basic set',  $actual, $expected, $results);
    }
}
