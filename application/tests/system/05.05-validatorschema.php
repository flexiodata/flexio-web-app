...
EOD;
        ...
        TestCheck::assertArray('A.1', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        $actual = array($r1,$r2,$r3,$r4,$r5,$r6,$r7,$r8,$r9,$r10,$r11,$r12,$r13,$r14,$r15,$r16);
        $expected = array(false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false);
        TestCheck::assertArray('A.2', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.3', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.4', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.5', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.6', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        $actual = array($r1,$r2,$r3,$r4,$r5,$r6,$r7,$r8,$r9,$r10,$r11,$r12,$r13,$r14,$r15,$r16);
        $expected = array(false,false,false,true,true,false,false,false,false,false,false,false,false,false,false,false);
        TestCheck::assertArray('A.7', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.8', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.9', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.10', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.11', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.12', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.13', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.14', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.15', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.16', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.17', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.18', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('B.1', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('B.2', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('B.3', 'ValidatorSchema::check(); return false if value isn\'t one of the enumerated values',  $actual, $expected, $results);
    }
}
