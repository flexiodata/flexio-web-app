...
EOD;
        ...
        $r19 = \Flexio\System\ValidatorSchema::check($v19, $template)->hasErrors() === false;
        $r20 = \Flexio\System\ValidatorSchema::check($v20, $template)->hasErrors() === false;
        ...
        TestCheck::assertArray('A.1', '\Flexio\System\ValidatorSchema::check(); return false if the items parameter isn\'t an array or an object',  $actual, $expected, $results);
...
EOD;
        ...
        $actual = array($r1,$r2,$r3,$r4,$r5,$r6,$r7,$r8,$r9,$r10,$r11,$r12,$r13,$r14,$r15,$r16,$r17,$r18,$r19,$r20);
        $expected = array(false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false);
        TestCheck::assertArray('A.2', '\Flexio\System\ValidatorSchema::check(); return false if the items parameter isn\'t an array or an object',  $actual, $expected, $results);
...
EOD;
        ...
        $actual = array($r1,$r2,$r3,$r4,$r5,$r6,$r7,$r8,$r9,$r10,$r11,$r12,$r13,$r14,$r15,$r16,$r17,$r18,$r19,$r20);
        $expected = array(false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false);
        TestCheck::assertArray('A.3', '\Flexio\System\ValidatorSchema::check(); return false if the items parameter isn\'t an array or an object',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.4', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.5', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.6', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.7', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.8', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.9', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.10', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.11', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.12', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        $actual = array($r1,$r2,$r3,$r4,$r5,$r6,$r7,$r8,$r9,$r10,$r11,$r12,$r13,$r14,$r15,$r16,$r17,$r18,$r19,$r20);
        $expected = array(true,true,true,true,true,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false);
        TestCheck::assertArray('A.13', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        TestCheck::assertArray('A.14', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
...
EOD;
        ...
        $actual = array($r1,$r2,$r3,$r4,$r5,$r6,$r7,$r8,$r9,$r10,$r11,$r12,$r13,$r14,$r15,$r16,$r17,$r18,$r19,$r20);
        $expected = array(true,true,true,true,true,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false);
        TestCheck::assertArray('A.15', '\Flexio\System\ValidatorSchema::check(); return false if an array doesn\'t validate against the items schema parameter',  $actual, $expected, $results);
    }
}
