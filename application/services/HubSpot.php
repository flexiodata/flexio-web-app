...
class HubSpot implements \Flexio\IFace\IConnection,
                         \Flexio\IFace\IOAuthConnection
{
    ...
    public static function create(array $params = null) : \Flexio\Services\HubSpot
    {
        $obj = new self;
    ...
    {
        // see here for more information about using hubspot oauth2:
        // https://developers.hubspot.com/docs/methods/oauth2/oauth2-overview

        $client_id = $GLOBALS['g_config']->hubspot_client_id ?? '';
        $client_secret = $GLOBALS['g_config']->hubspot_client_secret ?? '';
        ...
        else
        {
            ...
            $query_params = array(
                ...
                'state' => $params['state'] ?? '',
                'scope' => 'oauth',
                'optional_scope' => 'contacts content sales-email-read reports social business-intelligence', // additional optional scopes are available if needed; space-delimited
            );
