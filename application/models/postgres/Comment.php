...
/**
 *
 * Copyright (c) 2011-2013, Flex Research LLC. All rights reserved.
 *
 * Project:  Flex.io App
...
class Comment extends ModelBase
{
    ...
    public function update(array $filter, array $params) : bool
    {
        ...
        try
        {
            $updates_made = $db->update('tbl_comment', $process_arr, $filter_expr);
            return $updates_made;
        }
        catch (\Exception $e)
        {
    ...
    public function list(array $filter) : array
    {
        ...
        try
        {
            $query = "select * from tbl_comment where $filter_expr order by id $limit_expr";
    ...
    public function purge(string $owner_eid) : bool
    {
        ...
        try
        {
            ...
            $sql = "delete from tbl_comment where owned_by = $qowner_eid";
