...
class Pipe
{
    ...
    public static function setTaskStep(array $params, \Flexio\Api\Request $request) // TODO: set function return type
    {
        // the params that are posted is the task step; note: tasks don't
        // restrict key/values that can be passed, so don't limit them
    ...
    public static function getTaskStep(array $params, \Flexio\Api\Request $request) // TODO: set function return type
    {
        $validator = \Flexio\Base\Validator::create();
        if (($params = $validator->check($params, array(
                'eid'        => array('type' => 'identifier', 'required' => true),
